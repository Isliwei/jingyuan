<template>
   <div class="page-bar">
			...
			<ul v-if="this.all >= 1">
				<li v-if="cur>1"><a @click="cur--;pageClick(cur)">&lt;</a></li>
				<li v-if="cur==1"><a class="banclick">&lt;</a></li>
				<li v-for="index in indexs" :key="index.id" :class="{ 'active': cur == index}">
					<a @click="btnClick(index)">{{ index }}</a>
				</li>
				<li v-if="cur!=all"><a @click="cur++;pageClick(cur)">&gt;</a></li>
